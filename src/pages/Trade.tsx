...
export function Trade() {
  ...
  return <div className="page-stack">
    <section className="section-intro"><div><span className="eyebrow">REAL ASSET CONVERSION</span><h2>تحويل أصل إلى أصل</h2><p>التحويل/البيع الحقيقي فقط يخلق Realized P/L. تغيير السعر، الحساب، الحافظ أو المحفظة لا يفعل ذلك.</p></div></section>
    <section className="trade-grid">
      <div className="panel trade-form"><div className="panel-head"><div><h2>تفاصيل الصفقة</h2><span>حدد الحصة الاقتصادية التي خرجت وما استلمته فعليًا</span></div><ArrowLeftRight /></div>
        ...
        <label>نوع الأصل<select value={targetKind} onChange={e => setTargetKind(e.target.value as AssetKind)}><option value="currency">عملة</option><option value="metal">معدن</option><option value="fund">صندوق</option><option value="stock">سهم</option><option value="crypto">عملة رقمية</option><option value="other">أخرى</option></select></label>
