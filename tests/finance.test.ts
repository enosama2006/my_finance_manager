...
import { accountValueSar, applyConversion, assertPhysicalQuantityInvariant, assertPortfolioAllocationInvariant, availableByOwner, netWorthByOwner, portfolioRollupValueSar, previewConversion, updateValuation } from '../src/domain/finance'
...
describe('MyFinMan Foundation V4 invariants', () => {
  ...
  it('physical native quantity equals ownership shares', () => { expect(seedState.holdings.every(assertPhysicalQuantityInvariant)).toBe(true) })
